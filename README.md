...
Tutor de Paradigmas de Programación (UTN FRBA). Tres agentes (Wollok, Haskell, Prolog) con RAG sobre Supabase.
...
Ambas llaman al mismo turno de chat.
...
app/                      backend del agente
  ...
  infra/                  SQLite, RAG, LLMs
tests/
docs/                     anexos operativos
```
...
| `OPENROUTER_API_KEY` | Modelos cloud + embeddings RAG |
| `SUPABASE_URL` | Proyecto Supabase |
| `SUPABASE_ANON_KEY` | Lectura RAG con RLS (preferida) |
...
- [Supabase / RAG](docs/supabase.md)
- [Seguridad RLS](docs/security.md)
